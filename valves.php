        ...
        <div class="row">
            <div class="col-12 text-center">
                ...
                <ol class="breadcrumb justify-content-center p-0 m-0">
                    ...
                    <li class="breadcrumb-item active">Valves</li>
                </ol>
            </div>
        </div>
    </div>
                ...
                <div class="block">
                    ...
                    <article class="blog-post single">
                        <div class="post-thumb autoplay-slick">
                            <img src="images/products/sliders/valves-1.jpg" class="img-fluid" alt="speaker">
                        </div>
...
<script>
    $(function () {
        ...
        $('.valves-sidebar-li').closest('li').addClass('d-none');
