                ...
                <div class="block">
                    ...
                    <article class="blog-post single">
                        <div class="post-thumb autoplay-slick">
                            <img src="images/products/sliders/flanges-1.jpg" class="img-fluid" alt="speaker">
                            <img src="images/products/sliders/flanges-2.jpg" class="img-fluid" alt="speaker">
                        </div>
...
<script>
    $(function () {
        ...
        $('.flanges-sidebar-li').closest('li').addClass('d-none');
